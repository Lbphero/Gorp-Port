...
local assets =
{
    ...
    Asset("ANIM", "anim/saptree_nut.zip"),
}
...
local function plant(inst, growtime)
    local sapling = SpawnPrefab("saptree_sapling")
...
local function fn()
    ...
    inst.AnimState:SetBuild("saptree_nut")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/saptree_nut.xml"
...
return Prefab("saptree_nut", fn, assets, prefabs),
       MakePlacer("saptree_nut_placer", "acorn", "saptree_nut", "idle_planted")

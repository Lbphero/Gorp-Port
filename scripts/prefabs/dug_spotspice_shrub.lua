local function make_plantable(data)
    ...
    local function fn()
        ...
        inst.components.inventoryitem.atlasname = "images/inventoryimages/dug_spotspice_shrub.xml"
...
{
    {
        name = "spotspice_shrub",
        anim = "empty",
        bank = "dug_spotspice_shrub",
        build = "dug_spotspice_shrub",

...
local function OnPrefabOverrideIsDirty(inst)
    print("OnPrefabOverrideDirty: "  .. tostring(inst.prefaboverride:value() and inst.prefaboverride.GUID or nil))
...
local function fn()
    ...
    if TheNet:GetServerGameMode() == "quagmire" then
        ...
        if not TheWorld.ismastersim then
            ...
            inst:ListenForEvent("prefaboverridedirty", OnPrefabOverrideIsDirty)
        end
    end
    ...
    inst.components.burnable:OverrideBurnFXFinalOffset(-2)

...
local function fn()
    ...
    inst.components.spawner:Configure("gorge_swamppig", TUNING.TOTAL_DAY_TIME)
...
return Prefab("gorge_swamppig_house", fn, assets),
    Prefab("gorge_swamppig_house_rubble", rubblefn, assets)
